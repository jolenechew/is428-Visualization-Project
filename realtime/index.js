...
L.tileLayer("http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png", {
  attribution:
    '&copy; <a href="https://earthquake.usgs.gov/earthquakes/feed/v1.0/geojson.php">USGS Earthquake Hazards Program</a>, &copy; <a href="http://osm.org/copyright">OpenStreetMap</a> contributors',
  maxZoom: 20,
}).addTo(map2);
  ...
  geoJson2heat = function (geojson) {
    return geojson.features.map(function (feature) {
      ...
      return [
        ...
        parseFloat(feature.properties.mag) * 5,
      ];
    });
  };
    ...
    function (error, world) {
      ...
      d3.json(
        ...
        function (error, data) {
          ...
          var quakeCircles = svg
            .selectAll(".quake-circle")
            .data(quake)
            .transition()
            .delay(function (d) {
              return d.delay;
          ...
          var pulseCircles = svg
            .selectAll(".pulse-circle")
            .data(quake)
            .transition()
            .delay(function (d) {
              return d.delay;
