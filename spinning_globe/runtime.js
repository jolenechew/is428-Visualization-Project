...
class Inspector {
  ...
  rejected(t, n) {
    const { _node: a } = this;
    for (
      a.classList.remove("observablehq--running"),
        a.classList.add("observablehq--error");
      a.lastChild;
  ...
  function r(e, t) {
    ...
    function u() {
      ...
      if (34 === e.charCodeAt(a)) {
        for (
          ;
          (i++ < o && 34 !== e.charCodeAt(i)) || 34 === e.charCodeAt(++i);
...
const Ne = Ce("d3", "7.8.5", "dist/d3.min.js"),
  ...
  Te = Ce("@observablehq/plot", "0.6.13", "dist/plot.umd.min.js"),
...
function nt(
  ...
  return async function (r, a) {
    if (
      ...
      return r;
    if (/^[.]{0,2}\//i.test(r))
      return new URL(r, null == a ? location : a).href;
    ...
    if (
      (o.path && !et.test(o.path) && (o.path += ".js"),
      o.path && o.version && Qe.test(o.version))
    )
...
function at(e) {
  ...
  function o(e) {
    return arguments.length > 1
      ? Promise.all(Ze.call(arguments, n)).then(ot)
      : n(e);
  }
  return (
    (o.alias = function (t) {
      ...
      (a = e) &&
        ("function" == typeof a.sql ||
          ("function" == typeof a.queryTag &&
            ("function" == typeof a.query ||
              "function" == typeof a.queryStream))) &&
...
function Pt(e) {
  ...
  return (n, r) => {
    ...
    let a = t.get(n);
    return (
      (!a || (jt(n) && n.length !== a._numRows)) &&
        ((a = e(n, r)), (a._numRows = n.length), t.set(n, a)),
      a
    );
  };
}
...
function mn(
  ...
  for (const e of t) {
    ...
    const a = Math.max(1, 0.9 * t.defined),
      o =
        vt(pn, (e) => (t[e] >= a ? t[e] : NaN)) ??
        (t.string >= a ? "string" : "other");
...
var Ln = Object.freeze({
  ...
  range: function* (e, t, n) {
    ...
    for (var r = -1, a = 0 | Math.max(0, Math.ceil((t - e) / n)); ++r < a; )
      yield e + r * n;
  },
    ...
    function (e) {
      ...
      Object.defineProperties(
        ...
        ((n = {
          ...
          Inputs: () =>
            t(xe.resolve()).then((e) => ({ ...e, file: e.fileOf(gn) })),
          L: () =>
            (async function (e) {
      ...
      _rejector: {
        value:
          ...
          (e) => {
            if (e === nr) throw e;
            if (e === tr)
              throw new RuntimeError(`${a._name} is not defined`, a._name);
            if (e instanceof Error && e.message)
              throw new RuntimeError(e.message, a._name);
  ...
  _computeNow: {
    value: async function () {
      ...
      do {
        ...
        e.forEach(function (t) {
          fr(t) &&
            (vr(t, new RuntimeError("circular definition")),
            t._outputs.forEach(pr),
            e.delete(t));
        });
      } while (e.size);
      function a(e) {
